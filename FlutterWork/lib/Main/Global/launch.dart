...
class LaunchPod extends StatefulWidget {
  LaunchPod({Key key}) : super(key: key);

  @override
  _LaunchPodState createState() => _LaunchPodState();
}

String imageName="";

final _tagPControler = TextEditingController();
final _imagePControler = TextEditingController();


class _LaunchPodState extends State<LaunchPod> {
  @override
                            ...
                            border:
                             OutlineInputBorder(
                              borderRadius:BorderRadius.circular(40),
                               ...
                               hintText: " shashwat22/httpd_config ",
                               hintStyle: GoogleFonts.slackey(
                                 fontSize: 20,
                                 color:Color(0x60FFFFFF)
                               ),
                      ...
                      Card(
                            ...
                            FlatButton(
                              onPressed: () 
                              {
                               ...
                               _tagPControler.clear();
                               _imagePControler.clear();
                               execute(mainseru,subseru,tag,imageName);
                              },
                            child: Container(
                              width: 120,
                              height:45,
