...
final _tagSecretControler = TextEditingController();
final _tagKeyControler = TextEditingController();
final _tagValueControler = TextEditingController();
                     ...
                     child: Text("Tag : ",
                      ...
                      Container(
                        ...
                        child: TextField(
                          ...
                          controller: _tagSecretControler,
                           autofocus: true,
                           showCursor: true,
                           cursorWidth: 2,
                     ...
                     child: Text("Value : ",
                      ...
                      Card(
                            ...
                            FlatButton(
                              onPressed: () 
                              {
                              _tagSecretControler.clear();
                              _tagKeyControler.clear();
                              _tagValueControler.clear();
                              execute(mainseru,tag,key,value);
                              },
                            child: Container(
                              width: 120,
                              height:45,
